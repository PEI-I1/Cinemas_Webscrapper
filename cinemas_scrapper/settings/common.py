"""
Django settings for cinemas_scrapper project.
...
SECRET_KEY = ')!2sob0o-ugr!ipj(7js=x=u927i0l%a1n8$_hg(o&e6t1a^s%'
...
ROOT_URLCONF = 'cinemas_scrapper.urls'
...
WSGI_APPLICATION = 'cinemas_scrapper.wsgi.application'
